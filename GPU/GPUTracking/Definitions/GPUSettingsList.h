...
AddOptionRTC(addDeflectionInChi2, uint8_t, 0, "", 0, "1 = add the slope in the chi2 calculation for matching, 2 = in addition, take into account the full likelihood of the slope including exponential tails")
